...
from app.api.routes import agents, auth, compliance, company, health, query, regulations, logs, rag_health
...
def create_app() -> FastAPI:
    ...
    app.include_router(rag_health.router, prefix=f"{prefix}/rag", tags=["rag"])
