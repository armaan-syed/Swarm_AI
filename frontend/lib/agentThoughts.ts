/**
 * Professional technical reasoning thoughts for the dashboard reasoning panel.
 * These reflect the underlying logic of the 6-agent pipeline, providing
 * transparency into the regulatory analysis, extraction, and impact mapping stages.
 */
...
export const agentThoughtSequences: Record<string, ThoughtStep[]> = {
  ...
  communication_agent: [
    ...
    { text: "Personalizing briefing templates with department-specific action items...", durationMs: 700 },
    { text: "Pushing alerts to Brevo API gateway...", durationMs: 800 },
